...
#   set_location_assignment PIN_T2   -to cur_st[6]   ;# a HEX5S[6]
#  set_location_assignment PIN_P6   -to cur_st[5]   ;# b HEX5S[5]
#  set_location_assignment PIN_P7   -to cur_st[4]   ;# c HEX5S[4]
#  set_location_assignment PIN_T9   -to cur_st[3]   ;# d HEX5S[3]
#  set_location_assignment PIN_R5   -to cur_st[2]   ;# e HEX5S[2]
#  set_location_assignment PIN_R4   -to cur_st[1]   ;# f HEX5S[1]
#  set_location_assignment PIN_R3   -to cur_st[0]   ;# g HEX5S[0]

  ;# the group of 2 seven segments on the left

#   set_location_assignment PIN_R2   -to init_st[6]   ;# a HEX6S[6]
#   set_location_assignment PIN_P4   -to init_st[5]   ;# b init_st[5]
#   set_location_assignment PIN_P3   -to init_st[4]   ;# c init_st[4]
#   set_location_assignment PIN_M2   -to init_st[3]   ;# d init_st[3]
#   set_location_assignment PIN_M3   -to init_st[2]   ;# e init_st[2]
#   set_location_assignment PIN_M5   -to init_st[1]   ;# f init_st[1]
#   set_location_assignment PIN_M4   -to init_st[0]   ;# g init_st[0]
                                    
#   set_location_assignment PIN_L3   -to main_st[6]   ;# a HEX7S[6]
#   set_location_assignment PIN_L2   -to main_st[5]   ;# b HEX7S[5]
#   set_location_assignment PIN_L9   -to main_st[4]   ;# c HEX7S[4]
#   set_location_assignment PIN_L6   -to main_st[3]   ;# d HEX7S[3]
#   set_location_assignment PIN_L7   -to main_st[2]   ;# e HEX7S[2]
#   set_location_assignment PIN_P9   -to main_st[1]   ;# f HEX7S[1]
#   set_location_assignment PIN_N9   -to main_st[0]   ;# g HEX7S[0]
