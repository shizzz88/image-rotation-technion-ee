...
add wave -noupdate -group in_range_calc_proc -radix unsigned /addr_calc_tb/addr_calc_inst/x_crop_start_shift
add wave -noupdate -group in_range_calc_proc -radix unsigned /addr_calc_tb/addr_calc_inst/y_crop_start_shift
...
add wave -noupdate -group {control signals} -radix unsigned /addr_calc_tb/addr_calc_inst/pipe_counter
